...
https://stackoverflow.com/questions/67379273/less-or-equal-relation-with-largest-element-of-natural-number-list
|*)
...
If you `Search` without `"..."`, you search with a pattern that tries
to match part of the type definition.
