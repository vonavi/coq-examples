(** * Transitivity of subsequence in COQ
    ...
    ** Question
    I have been working my way through logical foundations and have
    gotten very stuck on the transitivity of subsequences exercise.
...
(** I am having trouble getting the right induction hypothesis after
    having tried a couple of different approaches. I have tried a
    number of approaches and end up with a situation where, in my
    assumptions, I have something like [subseq l2 (x::l3)] but then I
    need to prove [subseq l2 l3] which seems like a dead end. Any
