...
:Link: https://stackoverflow.com/q/66222181
|*)
...
(*|
but then I want to assert in the *definition* of ``int`` that ``succ
(pred x) = x`` and ``pred (succ x) = x``, and I'm not sure how to do
this.
|*)
