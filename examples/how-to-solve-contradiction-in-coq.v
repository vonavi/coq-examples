...
because it's pulling out the hypothesis. In cases where you're not
sure what to do, you can use intros to put the equality above the line
...
-- this is useful when you have an impossible goal but a contradiction
in your hypothesis (above the line). ``apply contra`` uses the fact
that ``<>`` is ``... -> False`` like I mentioned above.
|*)
